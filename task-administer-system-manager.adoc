...
+
image:screenshot-cvo-advanced-view.png["Capture d'écran d'un environnement de travail Cloud Volumes ONTAP affichant l'option basculer vers la vue avancée."]
...
+
image:screenshot-cvo-standard-view.png["Capture d'écran d'un environnement de travail Cloud Volumes ONTAP affichant l'option basculer vers la vue standard."]
