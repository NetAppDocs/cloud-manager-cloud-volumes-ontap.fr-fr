...
*** *Protection de purge*
*** *Chiffrement de disque Azure pour chiffrement de volume*
...
NOTE: Les trois premières autorisations ne sont pas nécessaires pour les paires haute disponibilité.
