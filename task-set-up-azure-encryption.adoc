...
* Pour les disques racine, de démarrage, NVRAM, de cœur et de données, Cloud Manager utilise un ensemble de chiffrement de disque qui permet de gérer les clés de chiffrement avec des disques gérés.
