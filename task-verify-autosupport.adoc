...
+
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["En savoir plus sur la connexion à la VM Linux pour le connecteur"^]
